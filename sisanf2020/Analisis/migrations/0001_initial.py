    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variacion_horizontal', models.DecimalField(decimal_places=2, max_digits=12)),
                ('porcentaje_horizontal', models.DecimalField(decimal_places=4, max_digits=7)),
                ('porcentaje_vertical', models.DecimalField(decimal_places=4, max_digits=7, null=True)),
                ('idAnalisis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Analisis.analisis')),
